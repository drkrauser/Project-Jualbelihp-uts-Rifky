package com.rxiff.jualbelihprifky;
...
import com.rxiff.jualbelihprifky.adapter.ListAdapterHandphone;
import com.rxiff.jualbelihprifky.hargahponline.DetailHandphone;
import com.rxiff.jualbelihprifky.hargahponline.FormHandphone;
import com.rxiff.jualbelihprifky.model.Handphone;
import com.rxiff.jualbelihprifky.server.AsyncInvokeURLTask;
    ...
    private void processResponse(String response) {
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                handphone.setNama(obj.getString("phone_name"));
                handphone.xsetHarga(obj.getString("price"));
