package com.rxiff.jualbelihprifky.server;
...
{
    public String mNoteItWebUrl = "aeroblank.blogspot.com";
    ...
    public String url_server = "http://ea235c0a.ngrok.io/xphone/";
    ...
    public void onPreExecute() {
        if (showdialog)
            this.dialog =
                    ProgressDialog.show(applicationContext,message, "Silahkan Menunggu...",
                            true);
    }
    @Override
